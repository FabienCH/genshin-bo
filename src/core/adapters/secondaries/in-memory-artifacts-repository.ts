...
export class InMemoryArtifactsRepository implements ArtifactsRepository {
  private readonly flowerArtifactsData: ArtifactData[];
  private readonly plumeArtifactsData: ArtifactData[];
  private readonly sandsArtifactsData: SandsArtifactData[];
  private readonly gobletArtifactsData: GobletArtifactData[];
  private readonly circletArtifactsData: CircletArtifactData[];
